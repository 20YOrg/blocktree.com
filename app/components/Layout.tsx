...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#131313]">
      ...
      <header
        ref={headerRef}
        className="fixed w-full bg-black bg-opacity-60 sm:shadow-md z-10 top-0 backdrop-blur-16"
      >
...
{/* Mobile Menu */}
<div
  className={`md:hidden bg-black bg-opacity-60 shadow-md transition-all duration-500 ease-in-out fixed w-full z-10 backdrop-blur-16 mobile-menu ${
    isMenuOpen ? "max-h-96 pointer-events-auto" : "max-h-0 pointer-events-none"
  }`}
...
>
  ...
  >
    <Link
      to="https://github.com/unit-index/blocktree.com"
      ...
      <footer className="bg-[#111111] py-10">
        <div className="max-w-7xl mx-auto px-4 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-2 mt-4 md:mt-0">
            <a
              href="https://github.com/unit-index/blocktree.com"
              target="_blank"
