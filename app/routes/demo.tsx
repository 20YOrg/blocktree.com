    ...
    const handleMine = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const newNodeName = `${grownBranch === "mainChain"
                    ? "R"
            ...
            <div className="w-full max-w-4xl mx-auto px-4 md:px-12 py-12 mt-[4rem] relative z-0">
                ...
                <div className="mt-4 flex justify-center gap-4">
                    <button
                        ...
                        className={`group flex items-center justify-center gap-2 rounded-[10px] border border-[#3B3B3B] bg-[rgba(44,44,44,0.60)] px-4 py-2 transition-all font-poppins text-white ${miningStatus === "mining"
                    ...
                    <button
                        ...
                        disabled={miningStatus === "mining"}
                        className={`group rounded-[10px] border border-[#3B3B3B] bg-[rgba(44,44,44,0.60)] px-4 py-2 transition-all font-poppins text-white ${miningStatus === "mining"
                            ? "opacity-50 cursor-not-allowed"
                            : "hover:bg-[rgba(60,60,60,0.60)] hover:shadow-[4px_4px_20px_10px_rgba(96,96,96,0.20)]"
                            }`}
                        style={{ fontSize: isMediumScreen ? '0.875rem' : '16px', fontWeight: 'semibold' }}
