...
export default function Demo() {
  ...
  if (!isMounted) {
    return (
      <div className="w-full max-w-4xl mx-auto px-4 py-12 mt-[8rem]">
        <h1 className="text-center text-white font-poppins text-[40px] font-medium leading-normal">
          Blocktree Demo
        </h1>
        <p className="mt-4 text-center text-white font-poppins text-base font-extralight leading-normal">
    ...
    <div className="w-full max-w-4xl mx-auto px-4 py-12 mt-[8rem]">
      ...
      <div className="mt-4 flex justify-center gap-4">
        <button
          ...
          className={`group flex items-center justify-center gap-2 rounded-[10px] border border-[#3B3B3B] bg-[rgba(44,44,44,0.60)] px-4 py-2 transition-all font-poppins text-[16px] font-semibold text-white ${
            miningStatus === "mining"
        ...
        <button
          onClick={resetView}
          className="rounded-[10px] border border-[#3B3B3B] bg-[rgba(44,44,44,0.60)] px-4 py-2 transition-all font-poppins text-[16px] font-semibold text-white hover:bg-[rgba(60,60,60,0.60)] hover:shadow-[4px_4px_20px_10px_rgba(96,96,96,0.20)]"
        >
          Reset View
        </button>
        <button
          ...
          disabled={miningStatus === "mining"}
          className={`group rounded-[10px] border border-[#3B3B3B] bg-[rgba(44,44,44,0.60)] px-4 py-2 transition-all font-poppins text-[16px] font-semibold text-white ${
            miningStatus === "mining"
              ? "opacity-50 cursor-not-allowed"
              : "hover:bg-[rgba(60,60,60,0.60)] hover:shadow-[4px_4px_20px_10px_rgba(96,96,96,0.20)]"
          }`}
      ...
      <div
        className="mt-4 bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md"
        style={{ height: "300px" }}
      >
        <Tree
          ref={treeRef}
            ...
            <g>
              <defs>
                ...
                >
                  <stop
                    offset="0%"
                    style={{ stopColor: "#4b5e40", stopOpacity: 1 }}
                  />
                  <stop
                    offset="100%"
                    style={{ stopColor: "#2f3d27", stopOpacity: 1 }}
                  />
                </linearGradient>
                <linearGradient
                  id="marsGradient"
